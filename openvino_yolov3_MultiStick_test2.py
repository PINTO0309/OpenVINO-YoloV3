...
class NcsWorker(object):
    ...
    def __init__(self, devid, frameBuffer, results, camera_width, camera_height, number_of_ncs):
        ...
        self.heap_request = []
        self.inferred_cnt = 0
        self.forced_sleep_time = (1 / (self.num_requests * number_of_ncs))
    ...
    def predict_async(self):
        try:
            ...
            if reqnum > -1:
                #sleep(ncsworker.forced_sleep_time)
...
def inferencer(results, frameBuffer, number_of_ncs, camera_width, camera_height):
